...
var Share = /** @class */ (function () {
    ...
    Share.prototype.restore = function (options, callback) {
        return this.client.sendOperationRequest({
            options: options
...
var createPermissionOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib.__assign(tslib.__assign({}, SharePermission), { required: true })
    },
    contentType: "application/xml; charset=utf-8",
    responses: {
        201: {
...
var ShareFileClient = /** @class */ (function (_super) {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.context.download(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal, leaseAccessConditions: options.leaseAccessConditions }, updatedOptions), { spanOptions: spanOptions }))];
                                        case 1: 
                                        // Debug purpose only
                                        // console.log(
    ...
    ShareFileClient.prototype.exists = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createSpan("ShareFileClient-exists", options.tracingOptions), span = _a.span, spanOptions = _a.spanOptions;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
    ...
    ShareFileClient.prototype.deleteIfExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, res, e_6;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("ShareFileClient-deleteIfExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                    ...
                    case 3:
                        e_6 = _d.sent();
                        if (((_a = e_6.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "ResourceNotFound") {
                            span.setStatus({
                                code: api.CanonicalCode.NOT_FOUND,
    ...
    ShareFileClient.prototype.getRangeList = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, originalResponse, e_13;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.uploadData = function (data, options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    if (coreHttp.isNode && data instanceof Buffer) {
                        return [2 /*return*/, this.uploadBuffer(function (offset, count) { return data.slice(offset, offset + count); }, data.byteLength, tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    }
                    else {
    ...
    ShareFileClient.prototype.uploadSeekableBlob = function (blobFactory, size, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, numBlocks_1, transferProgress_1, batch, _loop_1, i, e_16;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.uploadFile = function (filePath, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, size, e_17;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.uploadResetableStream = function (streamFactory, size, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, numBlocks_2, transferProgress_2, batch, _loop_2, i, e_18;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.uploadBuffer = function (bufferChunk, size, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, numBlocks_3, transferProgress_3, batch, _loop_3, i, e_19;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.downloadToBuffer = function (bufferOrOffset, offsetOrCount, countOrOptions, optOptions) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            var buffer, offset, count, options, _a, span, spanOptions, response, transferProgress_4, batch, _loop_4, off, e_20;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.uploadStream = function (stream, size, bufferSize, maxBuffers, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, transferProgress_5, scheduler, e_21;
            var _this = this;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.listHandlesSegment = function (marker, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, e_23;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.listHandleItems = function (options) {
        ...
        return tslib.__asyncGenerator(this, arguments, function listHandleItems_1() {
            var marker, _a, _b, listHandlesResponse, _i, _c, handle, e_24_1;
            var e_24, _d;
    ...
    ShareFileClient.prototype.forceCloseAllHandles = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, handlesClosed, numberOfHandlesFailedToClose, marker, response, e_26;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareFileClient.prototype.forceCloseHandle = function (handleId, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, rawResponse, response, e_27;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var ShareLeaseClient = /** @class */ (function () {
    ...
    ShareLeaseClient.prototype.changeLease = function (proposedLeaseId, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, e_29;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var ShareDirectoryClient = /** @class */ (function (_super) {
    ...
    ShareDirectoryClient.prototype.createIfNotExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, res, e_2;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("ShareDirectoryClient-createIfNotExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, 4, 5]);
                    ...
                    case 3:
                        e_2 = _d.sent();
                        if (((_a = e_2.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "ResourceAlreadyExists") {
                            span.setStatus({
    ...
    ShareDirectoryClient.prototype.createSubdirectory = function (directoryName, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, directoryClient, directoryCreateResponse, e_4;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.deleteSubdirectory = function (directoryName, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, directoryClient, e_5;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.createFile = function (fileName, size, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, fileClient, fileCreateResponse, e_6;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.deleteFile = function (fileName, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, fileClient, e_7;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.exists = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createSpan("ShareDirectoryClient-exists", options.tracingOptions), span = _a.span, spanOptions = _a.spanOptions;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.getProperties({
    ...
    ShareDirectoryClient.prototype.deleteIfExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, res, e_11;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("ShareDirectoryClient-deleteIfExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.delete(tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    ...
                    case 3:
                        e_11 = _d.sent();
                        if (((_a = e_11.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "ResourceNotFound") {
                            span.setStatus({
                                code: api.CanonicalCode.NOT_FOUND,
                                message: "Expected exception when deleting a directory only if it exists."
                            });
                            return [2 /*return*/, tslib.__assign(tslib.__assign({ succeeded: false }, (_b = e_11.response) === null || _b === void 0 ? void 0 : _b.parsedHeaders), { _response: e_11.response })];
                        }
                        span.setStatus({
                            code: api.CanonicalCode.UNKNOWN,
                            message: e_11.message
    ...
    ShareDirectoryClient.prototype.listFilesAndDirectoriesItems = function (options) {
        ...
        return tslib.__asyncGenerator(this, arguments, function listFilesAndDirectoriesItems_1() {
            var marker, _a, _b, listFilesAndDirectoriesResponse, _i, _c, file, _d, _e, directory, e_13_1;
            var e_13, _f;
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.context.listFilesAndDirectoriesSegment(tslib.__assign(tslib.__assign({ marker: marker }, options), { spanOptions: spanOptions }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_14 = _b.sent();
                        span.setStatus({
    ...
    ShareDirectoryClient.prototype.listHandleItems = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__asyncGenerator(this, arguments, function listHandleItems_1() {
            var marker, _a, _b, listHandlesResponse, _i, _c, handle, e_15_1;
            var e_15, _d;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.forceCloseHandlesSegment = function (marker, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, rawResponse, response, e_17;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        marker = marker === "" ? undefined : marker;
                        return [4 /*yield*/, this.context.forceCloseHandles("*", tslib.__assign(tslib.__assign({ marker: marker }, options), { spanOptions: spanOptions }))];
                    case 2:
                        rawResponse = _b.sent();
                        response = rawResponse;
                        response.closedHandlesCount = rawResponse.numberOfHandlesClosed || 0;
    ...
    ShareDirectoryClient.prototype.forceCloseAllHandles = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, handlesClosed, numberOfHandlesFailedToClose, marker, response, e_18;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareDirectoryClient.prototype.forceCloseHandle = function (handleId, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, rawResponse, response, e_19;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var ShareClient = /** @class */ (function (_super) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.context.create(tslib.__assign(tslib.__assign({}, options), { spanOptions: spanOptions }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_1 = _b.sent();
                        span.setStatus({
    ...
    ShareClient.prototype.createIfNotExists = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("ShareClient-createIfNotExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.create(tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
    ...
    ShareClient.prototype.createFile = function (fileName, size, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, directoryClient, fileClient, fileCreateResponse, e_5;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareClient.prototype.deleteFile = function (fileName, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, directoryClient, fileClient, e_6;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareClient.prototype.exists = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createSpan("ShareClient-exists", options.tracingOptions), span = _a.span, spanOptions = _a.spanOptions;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.getProperties({
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.context.deleteMethod(tslib.__assign(tslib.__assign({}, options), { spanOptions: spanOptions }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_9 = _b.sent();
                        span.setStatus({
    ...
    ShareClient.prototype.deleteIfExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, res, e_10;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("ShareClient-deleteIfExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.delete(tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
    ...
    ShareClient.prototype.getAccessPolicy = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, res, _i, response_1, identifier, e_12;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ShareClient.prototype.setAccessPolicy = function (shareAcl, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, acl, _i, _b, identifier, e_13;
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.context.createSnapshot(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal }, options), { spanOptions: spanOptions }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_14 = _b.sent();
                        span.setStatus({
    ...
    ShareClient.prototype.getStatistics = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, GBBytes, e_16;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var ShareServiceClient = /** @class */ (function (_super) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.serviceContext.listSharesSegment(tslib.__assign(tslib.__assign({ marker: marker }, options), { spanOptions: spanOptions }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_6 = _b.sent();
                        span.setStatus({
    ...
    ShareServiceClient.prototype.undeleteShare = function (deletedShareName, deletedShareVersion, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, shareClient, e_7;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createSpan("ShareServiceClient-undeleteShare", options.tracingOptions), span = _a.span, spanOptions = _a.spanOptions;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        shareClient = this.getShareClient(deletedShareName);
                        return [4 /*yield*/, new ShareClientInternal(shareClient.url, this.pipeline).restore({
